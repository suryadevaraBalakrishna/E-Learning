...
exports.register = async (request, response) => {
    ...
    var existingUser = await userModal.findOne({ email: request.body.email, deletedAt: null, role_type: 'User' })
...
exports.view = async (request, response) => {
    ...
    try {
        ...
        var userData = await userModal.findOne({ _id: decoded.userData._id, role_type: 'User' });
...
exports.forgotPassword=async(request,response)=>{
      var existingUser = await userModal.findOne({ email: request.body.email, deleted_at:null,role_type:'User' })
